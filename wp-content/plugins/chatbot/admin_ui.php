                ...
                <div class="wp-chatbot-tabs wp-chatbot-tabs-style-flip">
					...
					<section id="section-flip-5">
                        ...
                        <!--<section id="section-flip-8">
                            <div class="top-section">
                                <div class="wp-chatbot-language-center-summmery">
                                    <p><?php esc_html_e('WPBot will be opened based on the following settings', 'wpchatbot'); ?> </p>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h4 class="qc-opt-title"><?php esc_html_e('Enable Bot Activity Hour', 'wpchatbot'); ?> </h4>
                                        <div class="cxsc-settings-blocks" style="padding:0 20px;">
                                            ...
                                            <label for="enable_wp_chatbot_opening_hour"><?php esc_html_e('If enabled WPBot will show only during the time schedule you set below. The timezone you set from WordPress general settings will be used.', 'wpchatbot'); ?> </label>
                                        </div>
                                    </div>
                                </div>
                                <style>
                                ...
                                <div class="row" id="wp-chatbot-hours-wrapper">
                                    <div class="col-xs-12">
                                        <h4 class="qc-opt-title"><?php esc_html_e('WPBot Bot Activity Hours', 'wpchatbot'); ?> </h4>
                                        <?php
